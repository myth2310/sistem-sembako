<aside id="sidebar-wrapper">
  ...
  <ul class="sidebar-menu">
    ...
    <li><a class="nav-link" href="laporan.php"><i class="fas fa-wallet"></i><span>Laporan Penjualan</span></a></li>
    <li><a class="nav-link" href="saldo.php"><i class="fas fa-wallet"></i><span>Saldo</span></a></li> -->
  </ul>
</aside>