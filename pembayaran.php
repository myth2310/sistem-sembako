                      ...
                      <div id="items-container">
                        ...
                        <div class="row">
                          <div class="col-md-12 mb-4">
                            <button type="button" class="btn btn-success" id="btnTambahItem" onclick="addNewItem()">Tambah Barang Beli</button>
                          </div>
                        </div>
                      </div>
                      <div class="row">
    ...
    $(document).ready(function() {
      ...
      function recalculateTotal() {
        ...
        $(".item-container").each(function() {
          ...
          $(this).find(".total_per_satuan").val(totalPerSatuan.toFixed(2));
        });
